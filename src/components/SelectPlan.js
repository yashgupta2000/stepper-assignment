        ...
        <div className='flex flex-col h-screen'>
            <div className='flex-grow overflow-y-auto p-4'>
                ...
                <div className='  flex justify-between m-auto mt-16 gap-4 flex-wrap w-full md:w-2/3 lg:w-2/3 px-4 lg:px-0'>
                    ...
                    {
                        Datas?.map((item) => (
                            <div onClick={() => handleSelectPlan(item)} className={`rounded-md border-2 w-full md:w-3/12 py-5 cursor-pointer ${selectedPlan?.index === item.index ? 'border-blue-500 bg-gray-100' : 'border-gray-300 hover:border-blue-500 hover:bg-gray-100'
                                }`}>
                                <div className={`flex flex-col px-4`}>
                                    <div className="flex  md:flex-col">
                                        ...
                                        <div className="md:mt-12 flex flex-col ml-4 lg:ml-0 md:ml-0">
                                            ...
                                            <p className="text-gray-600 text-left text-sm  md:ml-0">${item.price}m/o</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='flex w-2/3 justify-center gap-4 m-auto rounded-md p-3 bg-gray-100   mt-6'>
                    ...
                    {selectedBilling === 'Monthly' ?
                        ...
                        : <svg onClick={toggleBilling} xmlns="http://www.w3.org/2000/svg" width={30} viewBox="0 0 576 512"><path d="M192 64C86 64 0 150 0 256S86 448 192 448l192 0c106 0 192-86 192-192s-86-192-192-192L192 64zm192 96a96 96 0 1 1 0 192 96 96 0 1 1 0-192z" /></svg>
                    }
                    <p>Yearly</p>
                </div>
            </div>
