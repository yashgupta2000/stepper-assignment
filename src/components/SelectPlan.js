        ...
        <div className='flex flex-col h-screen'>
            <div className='flex-grow overflow-y-auto p-4'>
                ...
                <div className='  flex justify-between m-auto mt-16 gap-4 flex-wrap w-full md:w-2/3 lg:w-2/3 px-4 lg:px-0'>
                    ...
                    {
                        Datas?.map((item) => (
                            <div onClick={() => handleSelectPlan(item)} className={` rounded-md border-2 w-full md:w-3/12 py-5 cursor-pointer ${selectedCard === item.index ? 'border-blue-500 bg-gray-100' : 'border-gray-300 hover:border-blue-500 hover:bg-gray-100'}`}>
